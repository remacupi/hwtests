...
#Scenario Example 2 FAILS, JIRAISSUE https://remacupi.atlassian.net/browse/FAC-1
#Scenario Example 3 FAILS, JIRAISSUE https://remacupi.atlassian.net/browse/FAC-2
...
Scenario Outline: Calculate web factorial valid numbers
      ...
      Examples:
        ...
        | 999 | 4.0238726007e+2564 |

#Scenario Example 1 FAILS, JIRAISSUE https://remacupi.atlassian.net/browse/FAC-4
